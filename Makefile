...
PutHTML:
	cp html/index.html /var/www/html/class/softdev/$(USER)/PhoneBook/html
	cp html/script.js /var/www/html/class/softdev/$(USER)/PhoneBook/html
	cp html/style.css /var/www/html/class/softdev/$(USER)/PhoneBook/html
